---
name: Part 1 Observability Plan
overview: "Plan for Part 1 observability analysis: verify observability rank deficiency, perform Kalman decomposition to separate observable/unobservable subspaces, and identify associated eigenvalues."
todos: []
---

# Part 1: Observability Analy

sis and Kalman Decomposition - Plan
...
**Script/Module**: `python/part1/observability_rank.py`**High-level approach**:
...
**Script/Module**: `python/part1/observability_rank.py` (same as above)**High-level approach**:
...
**Script/Module**: `python/part1/kalman_decomp_obsv.py`**High-level approach**:
...
**Script/Module**: `python/part1/kalman_decomp_obsv.py` (same as above)**High-level approach**:
...
**Script/Module**: `python/part1/main.py` or `python/part1/run_observability.py`**High-level approach**:
